<template>  
    <div class="input_wrap">
        ...
        <input  maxlength="3" @focus = "notEmpty($event)" @keyup="upnext($event)" @keydown="mgnextInput($event)" @blur = "testFormat($event,'ip_piece',empty)" class="ip_input ip_d" type="text">/
