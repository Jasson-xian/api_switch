<template>
	<div @keyup.enter="setNovnet()" @click.self='dataFresh()' class="modal" id="addnovnet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
						...
						<tbody v-show="result!='loading'&&result!='success'">
							...
							<tr>
								...
								<td>
									...
									@blur="testVal('.novlanid', 'vlanid')" class="novlanid" placeholder="2">
				...
				<div class="modal-footer">
					...
					<button class="enter button button--aylen" @click="setNovnet()">确认</button>
