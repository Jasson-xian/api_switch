<template>
    <div @keyup.enter="setVnet()" @click.self='dataFresh()' class="modal" id="addvnet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				<div class="modal-body">
					<table class="table">
						<thead>
							<tr>
								<th colspan="2">{{oper}}虚拟网络网段配置
									<span @click='dataFresh()' class="close" data-dismiss="modal" aria-hidden="true">&times;</span>
								</th>
							</tr>
						</thead>
						<!--正在请求-->
						...
						<tbody v-show="result!='loading'&&result!='success'">
							...
							<tr>
								...
								<td>
									...
									@blur="testVal('.vlanid', 'vlanid')"  class="vlanid" placeholder="2">
					...
					<div class="modal-footer">
						...
						<button class="enter button button--aylen" @click="setVnet()">确认</button>
